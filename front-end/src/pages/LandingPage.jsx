...
export default function LandingPage() {
  ...
  {darkMode 
    ...
    : <MoonIcon className="h-6 w-6 text-gray-700" />}
      ...
      <main className="flex flex-col items-center justify-center flex-1 text-center px-6">
        ...
        <p className="text-lg max-w-2xl mb-8">
          iNtellecta is your all-in-one productivity hub that features a Pomodoro timer, 
          flashcards, AI study helpers, and to- do tracking to help you 
          stay organized and focused.
        </p>

        <div className="flex flex-wrap justify-center gap-4 mb-16">
          <Link to="/signup" className="px-8 py-3 bg-indigo-600 text-white rounded-xl shadow-lg hover:bg-indigo-700 transition">
            Wanna Get Started?
          </Link>
          <Link to="/signin" className="px-8 py-3 border rounded-xl hover:bg-indigo-50 transition" style={{ borderColor }}>
            I Have an Account
          </Link>
        </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 max-w-6xl" style={{ gap: "3rem" }}>
          <FeatureCard title="Pomodoro Focus" text="Stay productive with a smart timer that helps you focus, rest, and repeat effectively." cardBgClass={cardBgClass} />
          <FeatureCard title="Flashcards & Notes" text="Create and review flashcards to keep your learning organized and easy to retain." cardBgClass={cardBgClass} />
          <FeatureCard title="AI Study Helper" text="Leverage AI to summarize content, suggest materials, and boost your study sessions." cardBgClass={cardBgClass} />
        </div>
      </main>
      ...
      <footer className={`py-6 text-center text-sm border-t ${borderColor}`}>
        ...
        <div className="flex justify-center mt-2 gap-4">
          <a href="https://linkedin.com/in/paola-gonzalez-726322257" className="hover:text-indigo-600 transition">Paola's LinkedIn</a>
          <a href="https://www.linkedin.com/in/tommy-hernandez-arroyo-72193b339/" className="hover:text-indigo-600 transition">Tommy's LinkedIn</a>
        </div>
      </footer>
    </div>
  )
